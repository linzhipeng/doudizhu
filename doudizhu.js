...
var getCardType = function (arr) {
    ...
    arr.forEach(function (card, index) {
        var cardWeight = cardInfo.getWeight(card)
...
// 压牌，判断是否能够进行压牌
// 返回布尔值
var beat = function (prevArr, nextArr) {
    var prevArrType = getCardType(prevArr)
    var nextArrType = getCardType(nextArr)
    // 保证牌都是合法的
...
module.exports.getShuffleCards = getShuffleCards
